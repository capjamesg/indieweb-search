...
def parse_advanced_search(advanced_filter_to_search, query_with_handled_spaces, query_values_in_list):
	...
	if look_for != -1:
		...
		if "before" in advanced_filter_to_search or "after" in advanced_filter_to_search:
			query_values_in_list[advanced_filter_to_search[:-1]] = datetime.datetime.strptime(get_value[0], "%Y-%d-%m")
		else:
...
def handle_advanced_search(query_with_handled_spaces):
	...
	query_values_in_list, query_with_handled_spaces = parse_advanced_search('category:"', query_with_handled_spaces, query_values_in_list)
	query_values_in_list, query_with_handled_spaces = parse_advanced_search('mf2prop:"', query_with_handled_spaces, query_values_in_list)
